...
public class Reservation {
    ...
    private Guests     Guests;        // ✅ uses Guests, not Customers
    private Room      room;
    ...
    public Reservation(Guests Guests, Room room, LocalDate checkIn, LocalDate checkOut) {
        this.Guests    = Guests;
        this.room     = room;
    ...
    public Guests     getGuest()                   { return Guests; }
    public void      setGuest(Guests v)            { this.Guests = v; }
    ...
    public String toString() {
        return "Res #" + reservationId + " — " + (Guests != null ? Guests.getFullName() : "");
    }
