...
abstract class CustomerTemplate{
    abstract Guest mapRow(ResultSet rs) throws SQLException ;
    abstract void addGuest(Guest g) throws SQLException;
    abstract Guest getGuestById(int id) throws SQLException;
    abstract Guest getGuestByEmail(String email) throws SQLException;
    abstract List<Guest> getAllGuests() throws SQLException;
    abstract void updateGuest(Guest g) throws SQLException;
    abstract void deleteGuest(int id) throws SQLException;
};


public class GuestDAO extends CustomerTemplate{
