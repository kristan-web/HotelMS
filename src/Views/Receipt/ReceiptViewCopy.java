...
public class ReceiptViewCopy extends javax.swing.JFrame {
    ...
    /**
     * Constructor that pre-populates the receipt with real reservation data.
     *
     * @param reservationId  the reservation ID
     * @param guestName      full name of the guest
     * @param guestAddress   address of the guest (can be empty)
     * @param roomNumber     room number string
    ...
    /**
     * Fills all receipt labels and the items table with actual reservation data.
     * Call this after initComponents() if you used the no-arg constructor.
     */
    ...
    /**
     * Sends jPanel1 to the system printer via Java2D printing.
     */
    ...
    /**
     * Saves jPanel1 as a PDF using Java2D printing to a PDF stream.
     * Opens a JFileChooser so the user can pick the save location.
     */
    ...
    /** Fallback: renders jPanel1 to a PNG file when no PDF printer is available. */
