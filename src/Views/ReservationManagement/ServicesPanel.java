...
public class ServicesPanel extends javax.swing.JPanel {
    ...
    public void loadGuestAndServices() {
        javax.swing.DefaultComboBoxModel<Guest> guestModel = new javax.swing.DefaultComboBoxModel<>();
        List<Guest> guests = guestCtrl.getAllGuests();
    ...
    private void handleBook() {
        ...
        if (!(guestObj instanceof Guest)) {
            javax.swing.JOptionPane.showMessageDialog(this, "Please select a guest.");
            return;
        }
    ...
    private void setupTable() {
        tableModel = new javax.swing.table.DefaultTableModel(
            new String[]{"ID", "Guest", "Service", "Scheduled", "Duration", "Total (₱)", "Status"}, 0) {
    ...
    private void initComponents() {
        ...
        guestCombo = new javax.swing.JComboBox<Guest>();
        ...
        jPanel4Layout.setHorizontalGroup(
            ...
            .addComponent(jScrollPane1, javax.swing.GroupLayout.Alignment.TRAILING,
                javax.swing.GroupLayout.DEFAULT_SIZE, 1127, Short.MAX_VALUE)
            .addGroup(jPanel4Layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(btnRefresh, javax.swing.GroupLayout.PREFERRED_SIZE, 99,
    ...
    private javax.swing.JComboBox<Guest>    guestCombo;
